// Generated by kea-typegen on Mon, 19 Feb 2024 18:52:17 GMT. DO NOT EDIT THIS FILE MANUALLY.

import type { Logic } from 'kea'

import type { ColorFormFields } from './oklchFormLogic'
...
export interface oklchFormLogicType extends Logic {
  actionCreators: {
    setColorFormValue: (
      ...
      type: "set color form value (src.logics.oklchFormLogic)";
      payload: {
        name: FieldName;
        value: any;
      };
    ...
    setColorFormValues: (values: DeepPartial<ColorFormFields>) => {
      type: "set color form values (src.logics.oklchFormLogic)";
      payload: {
        values: DeepPartial<ColorFormFields>;
      };
    };
    setColorFormManualErrors: (errors: Record<string, any>) => {
      type: "set color form manual errors (src.logics.oklchFormLogic)";
      payload: {
        errors: Record<string, any>;
      };
    };
    touchColorFormField: (key: string) => {
      type: "touch color form field (src.logics.oklchFormLogic)";
      payload: {
        key: string;
      };
    };
    resetColorForm: (values?: ColorFormFields) => {
      type: "reset color form (src.logics.oklchFormLogic)";
      payload: {
        values?: ColorFormFields;
      };
    };
    submitColorForm: () => {
      type: "submit color form (src.logics.oklchFormLogic)";
      payload: {
        value: boolean;
      };
    };
    submitColorFormRequest: (colorForm: ColorFormFields) => {
      type: "submit color form request (src.logics.oklchFormLogic)";
      payload: {
        colorForm: ColorFormFields;
      };
    };
    submitColorFormSuccess: (colorForm: ColorFormFields) => {
      type: "submit color form success (src.logics.oklchFormLogic)";
      payload: {
        colorForm: ColorFormFields;
      };
    };
    submitColorFormFailure: (
      ...
      type: "submit color form failure (src.logics.oklchFormLogic)";
      payload: {
        error: Error;
        errors: Record<string, any>;
      };
  ...
  actionKeys: {
    "set color form value (src.logics.oklchFormLogic)": "setColorFormValue";
    "set color form values (src.logics.oklchFormLogic)": "setColorFormValues";
    "set color form manual errors (src.logics.oklchFormLogic)": "setColorFormManualErrors";
    "touch color form field (src.logics.oklchFormLogic)": "touchColorFormField";
    "reset color form (src.logics.oklchFormLogic)": "resetColorForm";
    "submit color form (src.logics.oklchFormLogic)": "submitColorForm";
    "submit color form request (src.logics.oklchFormLogic)": "submitColorFormRequest";
    "submit color form success (src.logics.oklchFormLogic)": "submitColorFormSuccess";
    "submit color form failure (src.logics.oklchFormLogic)": "submitColorFormFailure";
  };
  actionTypes: {
    setColorFormValue: "set color form value (src.logics.oklchFormLogic)";
    setColorFormValues: "set color form values (src.logics.oklchFormLogic)";
    setColorFormManualErrors: "set color form manual errors (src.logics.oklchFormLogic)";
    touchColorFormField: "touch color form field (src.logics.oklchFormLogic)";
    resetColorForm: "reset color form (src.logics.oklchFormLogic)";
    submitColorForm: "submit color form (src.logics.oklchFormLogic)";
    submitColorFormRequest: "submit color form request (src.logics.oklchFormLogic)";
    submitColorFormSuccess: "submit color form success (src.logics.oklchFormLogic)";
    submitColorFormFailure: "submit color form failure (src.logics.oklchFormLogic)";
  };
  actions: {
  ...
  pathString: "src.logics.oklchFormLogic";
