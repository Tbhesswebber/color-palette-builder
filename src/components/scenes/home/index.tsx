...
export function Home() {
  return (
    <TextualLayout>
      ...
      <Paragraph fill>
        But I <i>love</i> design.
      </Paragraph>
      <Paragraph fill>
        So I've decided to build tools that keep me from investing my time in
        the complexity of design, which ultimately distracts me from creating
        value for users when I start web projects that don't have any design
        input.
      </Paragraph>
      <Paragraph fill>
      ...
      <List data={features} itemKey="name">
        {({ name, status, description, callouts }) => (
      ...
      <Paragraph fill>
        ...
        of them assume that you're clamping <Code>font-size</Code> to the viewport width. These tools
        lack control over output units and properties for zero reason that I can
        tell.
      </Paragraph>
      <Paragraph fill>
